            ...
            if (mysqli_num_rows($result) > 0) {
                while($row = mysqli_fetch_assoc($result)) {
                    ...
                    echo "<div class=\"file{$nowplaying}\">
                            ...
                            <div class=\"filebutton\" title='Vote up'><a href='addVote.php?id={$row['id']}&status=true'>&#128077;</a></div>
                            <div class=\"filebutton\" title='Vote down'><a href='addVote.php?id={$row['id']}&status=false'>&#128078;</a></div>
                        </div>";    
                }
            }
             unset( $file );
...
function renderButtons() {
    ...
    $viewmode = 'playlist'; //( isset( $_COOKIE['nm_viewmode'] ) && $_COOKIE['nm_viewmode'] == 'playlist' ) ? 'playlist' : 'browse';
...
PLBUTTONS;
    ...
    # rendering general buttons Voting Your Favourite Track
    echo <<<BUTTONS
    <div class="buttons">
        {$playlistbuttons}
...
<div id="stickycontainer">
    <div id="playercontainer">
        ...
        <div id="" align="center" style="color:white; font-size: 30px;">Vote Your Choise of Music Track</div>
        <br />
        <div id="player">
            <div id="albumart"></div>
            <div id="song">
